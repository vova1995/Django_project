...
SECRET_KEY = 'ffyu=sy6$^zg&y8zd)8+6emzzr7j5dnftl)q--z#r0$iav)-tr'
...
INSTALLED_APPS = [
    ...
    'my_app', #added my apps in order to django can see it
    'catalog',
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')], #it is in order to django see templates
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
